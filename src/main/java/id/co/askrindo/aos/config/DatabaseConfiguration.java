package id.co.askrindo.aos.config;

import id.co.askrindo.aos.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("id.co.askrindo.aos.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("id.co.askrindo.aos.repository.search")
